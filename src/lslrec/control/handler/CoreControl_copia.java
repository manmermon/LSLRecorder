...
public class CoreControl_copia extends Thread implements IHandlerSupervisor
{
	...
	private static CoreControl_copia core = null;
	 ...
	 */
	private CoreControl_copia() throws Exception
	{	
	 ...
	 */
	public static CoreControl_copia getInstance() throws Exception
	{
		if (core == null)
		{
			core = new CoreControl_copia();
		}
	...
	public synchronized void startWorking( boolean testWriting )
	{
		...
		{	
			ExceptionDialog.showMessageDialog( new ExceptionMessage(  new Throwable( "Exception recording" )
																	, "Exception"
	...
	*/
	...
	private class NotifiedEventHandler extends AbstractStoppableThread implements ITaskMonitor
	{
		...
		private CoreControl_copia.controlNotifiedManager ctrlManager = null;
