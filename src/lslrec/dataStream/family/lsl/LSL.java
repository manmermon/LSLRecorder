...
public class LSL {
    ...
    public static class StreamInfo {
        ...
        public StreamInfo(String name, String type, int channel_count, double nominal_srate) { obj = inst.lsl_create_streaminfo(name, type, channel_count, nominal_srate, LSLUtils.float32, ""); }
        public StreamInfo(String name, String type, int channel_count) { obj = inst.lsl_create_streaminfo(name, type, channel_count, IRREGULAR_RATE, LSLUtils.float32, ""); }
        public StreamInfo(String name, String type) { obj = inst.lsl_create_streaminfo(name, type, 1, IRREGULAR_RATE, LSLUtils.float32, ""); }
