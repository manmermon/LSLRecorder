...
{	
	...
	public SyncMarkerCollectorWriter( String file ) throws Exception 
	{
		...
		this.syncFileDisordered = OutputFileUtils.CreateTemporalBinFile( file + "_disordered" + this.ext);
	...
	*/
	...
	public SyncMarkerBinFileReader getSyncMarkerBinFileReader() throws Exception
	{
		...
		{		
			reader = new SyncMarkerBinFileReader( OutputFileUtils.CreateTemporalBinFile( this.outFileName )
	...
	{						
		...
		DataOutputStream outStream = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( OutputFileUtils.CreateTemporalBinFile( this.outFileName ) ) ) );
